      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mx-auto">
        {allPlayers.map((player) => (
          <div key={player.player_id} className="card shadow-2xl p-4">
            <figure>
              <img
                className="w-[28rem] h-[18rem] rounded-xl"
            ...
            <div className="">
              <div className="flex items-center gap-2 mt-4 lg:mt-6">
                <img
                  className="w-14 h-14 border-2 border-solid rounded-full object-cover"
                  src={player.player_profile}
                ></img>
                <h2 className="plyer-name text-lg md:text-xl lg:text-2xl font-semibold">
                  {player.player_name}
                </h2>
              </div>
              <div className="flex justify-between items-center mt-1 border-b-2 pb-2">
                <div className="flex items-center gap-2 justify-center">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <img
                      className="w-8 h-8 border-2 border-solid rounded-full object-cover"
                      src={player.national_flag}
                    ></img>
                  </div>
                </div>
                ...
                <button
                  type="button"
                  className="btn group flex h-12 w-36 items-center justify-center rounded-lg bg-gradient-to-r from-purple-500 via-red-500 to-yellow-500 p-[1.5px] text-white duration-300 hover:bg-gradient-to-l hover:shadow-2xl hover:shadow-purple-600/30"
                >
                  <div className="flex h-full w-full items-center justify-center rounded-lg bg-gray-900 transition duration-300 ease-in-out group-hover:bg-gradient-to-br group-hover:from-gray-700 group-hover:to-gray-900 group-hover:transition group-hover:duration-300 group-hover:ease-in-out">
                    {player.player_role}
                  </div>
                </button>
              </div>

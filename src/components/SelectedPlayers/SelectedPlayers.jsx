                    ...
                    playerQueue.map((player, idx) => (
                        <div key={idx} className="border-2 border-solid p-2 rounded-2xl flex justify-between items-center mb-2">
                            <div className="flex items-center gap-2">
                                ...
                                <img className="w-28 h-28 border-1 p-1 rounded-2xl" src={player.player_image} alt="Selected Players Image"></img>                            
                                </div>
                                <div className="flex flex-col gap-2">
                                    <h3 className="text-2xl font-bold text-[#131313]">{player.player_name}</h3>
                                    <p className="text-lg font-semibold text-gray-600">{player.player_role}</p>
                                    <p className="text-lg font-semibold text-gray-600">Price: {player.bidding_price}</p>
                                </div>
                            </div>
